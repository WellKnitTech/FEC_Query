...
class ContributionLimitsService:
    ...
    async def get_limit_for_contribution(
        ...
        if not contributor_category:
            # Try to infer from contribution_type_code or committee_type
            # For now, default to individual if we can't determine
            # TODO: Add logic to parse FEC transaction type codes
            contributor_category = self.CONTRIBUTOR_INDIVIDUAL
