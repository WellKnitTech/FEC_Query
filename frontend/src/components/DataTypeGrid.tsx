  ...
  return (
    <div className="bg-white shadow rounded-lg overflow-hidden">
      <div className="px-6 py-4 border-b border-gray-200 flex justify-between items-center">
        <h3 className="text-lg font-semibold text-gray-900">Data Types for {cycleStatus.cycle}</h3>
          ...
          <tbody className="bg-white divide-y divide-gray-200">
            {cycleStatus.data_types.map((dataType) => (
              <tr key={dataType.data_type} className="hover:bg-gray-50">
                ...
                <td className="px-6 py-4 whitespace-nowrap">
                  <div className="text-sm text-gray-900">{formatNumber(dataType.record_count)}</div>
                </td>
                <td className="px-6 py-4 whitespace-nowrap">
